...
output_path = '/home/maya/proj_deep/CLIPyourFood/results/resnet18_trained_w_clip_con'
...
net.load_state_dict(torch.load('/home/maya/proj_deep/CLIPyourFood/results/resnet18/resnet18.pt'),strict=False)
...
net.train()
#TODO check that still freeze works
